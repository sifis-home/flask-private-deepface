...
def find(
    ...
    Parameters:
            ...
            model_name (string): VGG-Face, Facenet, Facenet512, or Ensemble
            ...
            detector_backend (string): set face detector backend to opencv
    ...
    for target_img, target_region, _ in target_objs:
        ...
        result_df = result_df[
            result_df[f"{model_name}_{distance_metric}"] <= threshold
        ]
...
def represent(
    ...
    Parameters:
            ...
            model_name (string): VGG-Face, Facenet, Facenet512
...
def private_face_recognition(
    ...
    """
    This function applies real time face recognition
    ...
    Parameters:
            ...
            detector_backend (string): opencv
    ...
    labels_dict = realtime.private_analysis(
        db_path,
        model_name,
        detector_backend,
        distance_metric,
...
def extract_faces(
    ...
    Parameters:
            ...
            detector_backend (string): face detection backends is opencv
...
# @deprecated(
#     version="0.0.78",
#     reason="Use DeepFace.extract_faces instead of DeepFace.detectFace",
# )
# def detectFace(
#     img_path,
#     target_size=(224, 224),
