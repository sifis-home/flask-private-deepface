...
def load_image(img):
    ...
    if img.startswith("http"):
        return np.array(
            Image.open(requests.get(img, stream=True, timeout=60).raw).convert(
                "RGB"
            )
        )[:, :, ::-1]
...
# @deprecated(
#     version="0.0.78", reason="Use extract_faces instead of preprocess_face"
# )
# def preprocess_face(
#     img,
#     target_size=(224, 224),
...
#     """
#     print(
#         "⚠️ Function preprocess_face is deprecated. Use extract_faces instead."
#     )
#     result = None
